...
export const slidesData: MainSlide[] = [
    ...
    },
    {
        ...
        details: [
            ...
            { year: 2016, description: "Телескоп Hubble обнаружил самую удалённую из известных галактик — GN-z11" },
            { year: 2017, description: "Компания Tesla представила первый в мире электрический грузовик Tesla Semi" },
